...
export function OcTab(visible: Accessor<boolean>, hide: () => void, isActive: Accessor<boolean>) {
  ...
  const vpnStatus = createPoll(getVpnStatus(), 3000, () => getVpnStatus())
  ...
  return (
    <box vertical>
      <box class="vpn-header" vertical>
        <box>
          <label class="vpn-title" label="OpenConnect" xalign={0} hexpand />
